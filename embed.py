...
parser.add_argument(
    ...
    help='Number of threads used for parallel data loading.')#initial was 8

parser.add_argument(
    '--batch_size', default=20, type=common.positive_int,
    help='Batch size used during evaluation, adapt based on available memory.')#initial was 256
